...
public class ShootVisionTrueAutoFire extends CommandBase {
  ...
  public ShootVisionTrueAutoFire(DoubleSupplier forwardCommand, DoubleSupplier strafeCommand, DoubleSupplier spinCommand) {
  ...
  public void execute() {
    ...
    if (tx < 3 && tx > -3 && tv == 1 && forwardCommand.getAsDouble() == 0 && strafeCommand.getAsDouble() == 0) {
