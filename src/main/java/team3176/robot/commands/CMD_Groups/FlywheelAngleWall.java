...
public class FlywheelAngleWall extends CommandBase {
  Flywheel m_Flywheel = Flywheel.getInstance();
  Angler m_Angler = Angler.getInstance();
  public FlywheelAngleWall() {
    addRequirements(m_Flywheel, m_Angler);
  }

  @Override
  public void initialize() {
    m_Angler.moveToAngle(ShooterLocationValues.POINTS[4][5]);
    m_Flywheel.spinMotorsVelocityPID(ShooterLocationValues.POINTS[4][3], ShooterLocationValues.POINTS[4][4]);
  }
