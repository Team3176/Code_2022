...
public class ShootPIDToggleTest extends CommandBase {
  ...
  public void initialize() {
    ...
    m_Indexer.putSmartDashboardPIDControlCommands(indexerS);
    m_Feeder.putSmartDashboardPIDControlCommands(feederS);
  }
  ...
  public void execute() {
    ...
    m_Indexer.setPIDValuesFromSmartDashboard();
    m_Feeder.setPIDValuesFromSmartDashboard();
  }
