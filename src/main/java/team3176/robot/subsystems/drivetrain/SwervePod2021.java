...
import team3176.robot.constants.SwervePodConstants2021;
import team3176.robot.constants.MasterConstants;

public class SwervePod2021 {
    ...
    private double maxFps = SwervePodConstants2021.DRIVE_SPEED_MAX_EMPIRICAL_FEET_PER_SECOND;
    ...
    public SwervePod2021(int id, TalonFX driveController, TalonSRX spinController) {
        this.id = id;

        this.kEncoderOffset = SwervePodConstants2021.SPIN_OFFSET[this.id];
        ///System.out.println("P"+(this.id+1)+" kEncoderOffset: "+this.kEncoderOffset);

        kSpinEncoderUnitsPerRevolution = SwervePodConstants2021.SPIN_ENCODER_UNITS_PER_REVOLUTION;
        kSlotIdx_spin = SwervePodConstants2021.TALON_SPIN_PID_SLOT_ID;
        kPIDLoopIdx_spin = SwervePodConstants2021.TALON_SPIN_PID_LOOP_ID;
        kTimeoutMs_spin = SwervePodConstants2021.TALON_SPIN_PID_TIMEOUT_MS;

        m_drivePIDController = new PIDController(SwervePodConstants2021.P_MODULE_DRIVE_CONTROLLER, 0, 0);

        m_turningPIDController = new ProfiledPIDController(
            SwervePodConstants2021.P_MODULE_TURNING_CONTROLLER[0], 0, SwervePodConstants2021.P_MODULE_TURNING_CONTROLLER[2],
            new TrapezoidProfile.Constraints(
                (SwervePodConstants2021.MAX_MODULE_ANGULAR_SPEED_RADIANS_PER_SECOND),
                (SwervePodConstants2021.MAX_MODULE_ANGULAR_SPEED_RADIANS_PER_SECOND)));
        ...
        kDriveEncoderUnitsPerRevolution = SwervePodConstants2021.DRIVE_ENCODER_UNITS_PER_REVOLUTION;
        kSlotIdx_drive = SwervePodConstants2021.TALON_DRIVE_PID_SLOT_ID;
        kPIDLoopIdx_drive = SwervePodConstants2021.TALON_DRIVE_PID_LOOP_ID;
        kTimeoutMs_drive = SwervePodConstants2021.TALON_DRIVE_PID_TIMEOUT_MS;


        kP_Spin = SwervePodConstants2021.SPIN_PID[0][id];
        kI_Spin = SwervePodConstants2021.SPIN_PID[1][id];
        kD_Spin = SwervePodConstants2021.SPIN_PID[2][id];
        kF_Spin = SwervePodConstants2021.SPIN_PID[3][id];
    ...
    public double getVelocity_metersPerSec() {
        ...
        double metersPer100ms = sensoredVelInTicsPer100ms * 1 * wheelCircumference / (SwervePodConstants2021.DRIVE_ENCODER_UNITS_PER_REVOLUTION * 6.17);  //6.17 = gear ratio  <--should this be 6.17 here, or (1 / 6.17)?
