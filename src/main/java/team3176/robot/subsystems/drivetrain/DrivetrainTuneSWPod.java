...
public class DrivetrainTuneSWPod extends SubsystemBase {
  private static DrivetrainTuneSWPod instance = new DrivetrainTuneSWPod();
...
//private Vision m_Vision = Vision.getInstance();
 ...
 // private PowerDistribution PDP = new PowerDistribution(PowerManagementConstants.PDP_CAN_ID, ModuleType.kCTRE);
  ...
  public static DrivetrainTuneSWPod getInstance() {
    return instance;
  }
