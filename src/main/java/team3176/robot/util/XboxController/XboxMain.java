...
/**
 * Sets up a extention of a Trigger object where it can have none of the two modifiers active to run the base key
 */

public class XboxMain extends Trigger {
    ...
    public XboxMain(XboxController control, int button, int shiftKey, int DBLShiftKey) {
